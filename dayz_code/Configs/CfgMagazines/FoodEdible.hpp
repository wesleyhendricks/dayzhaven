...
class FoodMRE : FoodEdible {
	scope = public;
	count = 1;
	Nutrition[] = {150,500,300,0}; //[Energy,food,water,temp]
...
class FoodPistachio : FoodEdible {
	...
	Nutrition[] = {0,150,0,0}; //[Energy,food,water,temp]
};
...
class FoodCanBeef : FoodEdible {
	...
	Nutrition[] = {0,300,50,0}; //[Energy,food,water,temp]
};
class FoodCanPotatoes : FoodEdible {
	...
	Nutrition[] = {0,450,150,0}; //[Energy,food,water,temp]
};
class FoodCanGriff : FoodEdible {
	...
	Nutrition[] = {0,200,0,0}; //[Energy,food,water,temp]
};
class FoodCanBadguy : FoodEdible {
	...
	Nutrition[] = {0,100,0,0}; //[Energy,food,water,temp]
};
...
class FoodCanCorn : FoodEdible {
	...
	Nutrition[] = {0,300,100,0}; //[Energy,food,water,temp]
};
class FoodCanCurgon : FoodEdible {
	...
	Nutrition[] = {0,180,0,0}; //[Energy,food,water,temp]
};
class FoodCanDemon : FoodEdible {
	...
	Nutrition[] = {0,165,0,0}; //[Energy,food,water,temp]
};
class FoodCanFraggleos : FoodEdible {
	...
	Nutrition[] = {0,250,0,0}; //[Energy,food,water,temp]
};
class FoodCanHerpy : FoodEdible {
	...
	Nutrition[] = {0,300,0,0}; //[Energy,food,water,temp]
};
class FoodCanDerpy : FoodEdible {
	...
	Nutrition[] = {0,110,0,0}; //[Energy,food,water,temp]
};
class FoodCanOrlok : FoodEdible {
	...
	Nutrition[] = {0,160,0,0}; //[Energy,food,water,temp]
};
...
class FoodCanTylers : FoodEdible {
	...
	Nutrition[] = {0,30,0,0}; //[Energy,food,water,temp]
};
...
class FoodCanRusStew : FoodEdible {
	...
	Nutrition[] = {0,400,50,0}; //[Energy,food,water,temp]
};
...
class FoodCanRusMilk : FoodEdible {
	...
	Nutrition[] = {0,80,20,0}; //[Energy,food,water,temp]
};
class FoodCanRusCorn : FoodEdible {
	...
	Nutrition[] = {0,80,0,0}; //[Energy,food,water,temp]
};
...
class FoodChipsChocolate : FoodEdible {
	...
	Nutrition[] = {300,200,0,0}; //[Energy,food,water,temp]
};
...
class FoodCandyLegacys : FoodEdible {
	...
	Nutrition[] = {350,80,20,0}; //[Energy,food,water,temp]
};
...
class FoodCandyMintception : FoodEdible {
	...
	Nutrition[] = {300,80,40,0}; //[Energy,food,water,temp]
};
class FoodCanLongSprats : FoodEdible {
	...
	Nutrition[] = {50,100,20,0}; //[Energy,food,water,temp]
};