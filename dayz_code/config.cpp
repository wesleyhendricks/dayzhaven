...
class CfgAddons {
	...
	class PreloadAddons	{
		class dayz {
			list[] = {"BIS_fnc_init","dayz_code","dayz","dayz_equip","dayz_communityassets","dayz_weapons","dayz_communityweapons","dayz_sfx","ST_bunnyhop","st_collision","st_evasive","CfgVehicles"};
		};
	};
};
