	...
	class ItemFence : CA_Magazine {
		...
		class ItemActions {
			class Build {
				...
				script = "spawn player_build; r_action_count = r_action_count + 1;";
				require[] = {"ItemEtool"};
				create = "Fence_Ind_long";
			};
		};
	};
/*
	"Fence_corrugated_plate" -- (Wire Fence Tall - 1 Concrete post)
	"Fence_Ind_long"
	"Fence_Ind" -- (Wire Fence Tall - 1 Concrete post)
	"Fort_RazorWire"
	"Land_BagFenceLong"
	"Concrete_Wall_EP1"
	"Fort_StoneWall_EP1"
...
*/
	...
	class ItemcraftTable : CA_Magazine {
		scope = public;
		count = 1;
		type = 256;
		displayName = "Craft Table";
		picture = "\ca\data\data\Unknown_object.paa";
